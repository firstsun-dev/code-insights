...
## Corpus Check
- 557 files · ~746,868 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 4650 nodes · 8962 edges · 283 communities (256 shown, 27 thin omitted)
...
Cohesion: 0.06
Nodes (98): costAction(), handleStatsError(), modelsAction(), overviewAction(), AggregatedData, patternsAction(), projectsAction(), todayAction() (+90 more)

### Community 3 - "Community 3"
Cohesion: 0.04
Nodes (103): ProjectPersonalitySwitcher(), ProjectPersonalitySwitcherProps, EditSessionDialog(), RenameSessionDialog(), SessionDetailPanel(), useAnalyzeSession(), useAnalysisQueue(), useQueuedSessionIds() (+95 more)

### Community 4 - "Community 4"
Cohesion: 0.18
Nodes (23): CollapsibleToolPanel(), CollapsibleToolPanelProps, AgentToolPanel(), getAgentDisplayName(), getAgentInitials(), AskUserQuestionPanel(), parseAnswers(), Question (+15 more)

### Community 5 - "Community 5"
Cohesion: 0.05
Nodes (67): SortableInsightItemProps, ALL_TYPES, DISPLAY_TYPES, expand(), InsightTypePills(), InsightTypePillsProps, MERGED_TYPES, DecisionContent() (+59 more)

### Community 6 - "Community 6"
Cohesion: 0.04
Nodes (64): Logo(), LogoProps, CoverImagePromptSection(), CoverImagePromptSectionProps, DispatchDrawer(), DispatchDrawerProps, FORMAT_OPTIONS, INSIGHT_TYPE_COLORS (+56 more)

### Community 7 - "Community 7"
Cohesion: 0.09
Nodes (35): LlmNudgeBanner(), LlmNudgeBannerProps, localStorageKey(), TITLES, CategoryItem, CollapsibleCategoryList(), CollapsibleCategoryListProps, formatUtcDate() (+27 more)

### Community 8 - "Community 8"
Cohesion: 0.07
Nodes (58): ActivityChart(), ActivityChartProps, InsightTypeChart(), InsightTypeChartProps, LABELS, AnalyticsRange, CacheBySourceCard(), CacheBySourceCardProps (+50 more)

### Community 9 - "Community 9"
Cohesion: 0.08
Nodes (49): AnalysisContext, AnalysisContextValue, AnalysisProvider(), AnalysisState, AnalysisType, buildToastMessage(), makeKey(), makeToastId() (+41 more)

### Community 10 - "Community 10"
Cohesion: 0.08
Nodes (42): DedupMetrics, EMPTY_DEDUP_METRICS, InsightRow, mockEmbedFn(), NOTE: saveInsightsToDbWithDedup uses getDb() singleton internally for writes,, syncMockEmbedFn(), backfillAll(), backfillEmbeddings() (+34 more)
...
Cohesion: 0.06
Nodes (26): ClaudeCodeProvider, discoverJsonlFiles(), CrushProvider, MistralVibeProvider, VibeMessage, VibeMeta, antigravity, claudeCode (+18 more)

### Community 14 - "Community 14"
Cohesion: 0.14
Nodes (23): ConversationSearch(), EditProjectDialogProps, CommandPalette(), CommandPaletteProps, NAV_ITEMS, pushRecent(), readRecent(), RecentItem (+15 more)

### Community 15 - "Community 15"
Cohesion: 0.06
Nodes (48): bandFor(), computeAutonomy(), computeAxis(), computeCraft(), computePace(), computePersonalityProfile(), computePrecision(), computeResilience() (+40 more)

### Community 16 - "Community 16"
Cohesion: 0.16
Nodes (18): AnalysisUsageRow, getSessionAnalysisUsage(), SaveAnalysisUsageData, databaseChecks(), statusCommand(), closeDb(), DB_DIR, DB_PATH (+10 more)
...
Cohesion: 0.10
Nodes (39): analysisChecks(), configChecks(), checkPort(), dashboardChecks(), environmentChecks(), extractBinaryPath(), hooksChecks(), providerChecks() (+31 more)
...
Cohesion: 0.06
Nodes (43): ROUTE_TITLES, RouteEffects(), FloatingActionBar(), FloatingActionBarProps, HomeMultiSelect(), HomeMultiSelectProps, ProjectMultiSelect(), SavedFiltersDropdown() (+35 more)
...
Cohesion: 0.07
Nodes (35): ActivityFeed(), ActivityFeedProps, FeedItem, insightTypeIcons, insightTypeLabels, SessionFeedItem(), Header(), Layout() (+27 more)
...
Cohesion: 0.10
Nodes (24): cleanTitle(), detectSessionCharacter(), EDIT_TOOLS, extractBugDescription(), extractFromUserMessage(), extractToolFilePath(), extractTopic(), generateCharacterTitle() (+16 more)
...
Cohesion: 0.09
Nodes (46): buildEmbeddingConfig(), buildEmbeddingsCommand(), embeddingsBackfillCommand(), embeddingsRecomputeCommand(), embeddingsSearchCommand(), embeddingsStatusCommand(), statusRowToInt(), initCommand() (+38 more)
...
Cohesion: 0.15
Nodes (15): AntigravityNativeRunner, CodexNativeRunner, MistralVibeRunner, ClaudeEvent, ClaudeNativeRunner, ClaudeResultEvent, extractResultFromEnvelope(), AnalysisRunner (+7 more)
...
Cohesion: 0.15
Nodes (19): detectRageLoopHeuristic(), RageLoopSignal, classifyStoredUserMessage(), formatMessagesForAnalysis(), formatSessionMetaLine(), ParsedToolCall, ParsedToolResult, safeParseJson() (+11 more)
...
Cohesion: 0.07
Nodes (29): devDependencies, jsdom, tailwindcss, @tailwindcss/vite, @testing-library/dom, @testing-library/jest-dom, @testing-library/react, @testing-library/user-event (+21 more)
...
Cohesion: 0.10
Nodes (20): ASSET_CONTENT_TYPES, registerDocs(), require, swaggerUiDistDir, createApp(), ServerOptions, startServer(), app (+12 more)

### Community 62 - "Community 62"
Cohesion: 0.11
Nodes (20): generateFrictionWinsPrompt(), generatePersonalityPrompt(), generateRulesSkillsPrompt(), generateWorkingStylePrompt(), sampleEffectivePatterns, sampleFrictionCategories, ALL_SECTIONS, app (+12 more)
...
Cohesion: 0.15
Nodes (22): configCommand, describeApiKeySource(), llmCommand, PROVIDER_API_KEY_ENV, runInteractiveLLMConfig(), saveLLMConfig(), showConfigAction(), disableAction() (+14 more)
...
Cohesion: 0.13
Nodes (19): deletedCountRoute, deleteRoute, getRoute, listRoute, patchRoute, IMPORTANT: registered before /{id} so "deleted" isn't matched as a session ID, InsightTypeSchema, SessionCharacterSchema (+11 more)
...
Cohesion: 0.09
Nodes (29): applyGeneratedTitle(), convertPQToInsightRow(), convertToInsightRows(), DeleteOptions, deleteSessionInsights(), insertInsightsBatch(), markInsightStale(), saveInsightsToDb() (+21 more)
...
Cohesion: 0.15
Nodes (18): promptQualityRoute, recurringRoute, sessionAnalysisRoute, usageRoute, loadSessionForAnalysis(), loadSessionMessages(), ProgressMessageFn, streamBatchBackfill() (+10 more)

### Community 89 - "routes/facets.ts"
Cohesion: 0.12
Nodes (18): aggregatedRoute, listRoute, missingPqRoute, missingRoute, outdatedPqRoute, outdatedRoute, AggregatedDataSchema, AggregatedEffectivePatternSchema (+10 more)
...
Cohesion: 0.09
Nodes (34): HomeSelect(), HomeSelectProps, ProjectMultiSelectProps, DOT_COLORS, SOURCE_TOOLS, SourceToolSelect(), SourceToolSelectProps, EditProjectDialog() (+26 more)
...
### Community 96 - "analysis/analysis-db.ts"
Cohesion: 0.14
Nodes (19): AgentMessageBubble(), AgentMessageBubbleProps, getStatusBadgeClass(), TaskNotificationCard(), TeammateMessageCard(), getAssistantConfig(), MessageBubble(), classifyUserMessage() (+11 more)
...
Cohesion: 0.17
Nodes (17): dashboardCommand(), DashboardOptions, isPortInUse(), filterFilesToSync(), runSync(), SyncOptions, SyncResult, syncSingleFile() (+9 more)
...
Cohesion: 0.29
Nodes (3): KiloProvider, ParsedMessage, getKiloDir()
...
Cohesion: 0.22
Nodes (9): properties, summary, additionalProperties, required, type, bullets, content, outcome (+1 more)
...
Cohesion: 0.22
Nodes (10): createInsightRoute, deleteRoute, listRoute, VALID_TYPES, CreateInsightResponseSchema, InsightIdParamSchema, InsightSchema, InsightScopeSchema (+2 more)
...
Cohesion: 0.22
Nodes (16): sessionExists(), getStmts(), insertMessages(), insertSessionWithProject(), insertSessionWithProjectInternal(), truncate(), updateGlobalUsageStats(), upsertProject() (+8 more)
...
### Community 164 - "AssistantMarkdown.tsx"
Cohesion: 0.22
Nodes (11): CopyButton(), CopyButtonProps, AssistantMarkdown(), AssistantMarkdownProps, highlightString(), highlightText(), processNode(), UserMarkdown() (+3 more)
...
Cohesion: 0.29
Nodes (7): app, listRoute, MessageSchema, MessagesParamsSchema, MessagesQuerySchema, MessagesResponseSchema, parseIntParam()
...
Cohesion: 0.23
Nodes (13): AnalysisResponse, ContentBlock, ParseError, ParseResult, PromptQualityDimensionScores, PromptQualityFinding, PromptQualityTakeaway, buildResponsePreview() (+5 more)
...
### Community 174 - "MistralVibeProvider"
Cohesion: 0.25
Nodes (13): AgentToolPanelProps, AskUserQuestionPanelProps, FileToolPanelProps, GenericToolPanel(), GenericToolPanelProps, SearchToolPanelProps, TerminalToolPanelProps, TOOL_ALIASES (+5 more)
...
Cohesion: 0.19
Nodes (15): CLI_ENTRY, readStdin(), sessionEndCommand(), SessionEndOptions, spawnWorker(), WORKER_LOG_PATH, enqueue(), getVersion() (+7 more)
...
Cohesion: 0.18
Nodes (11): additionalProperties, required, type, facets, course_correction_reason, effective_patterns, friction_points, had_course_correction (+3 more)
...
Cohesion: 0.20
Nodes (11): ChatConversation(), ChatConversationProps, shouldShowDateSeparator(), ConversationSearchProps, DateSeparator(), DateSeparatorProps, LoadMoreSentinel(), LoadMoreSentinelProps (+3 more)

### Community 189 - "MessageBubble.tsx"
Cohesion: 0.20
Nodes (9): ContextBreakDivider(), ContextBreakDividerProps, InlineEventChip(), InlineEventChipProps, RawMessageBlock(), RawMessageBlockProps, formatCharCount(), ThinkingBlock() (+1 more)
...
### Community 196 - "ThemeProvider.tsx"
Cohesion: 0.21
Nodes (10): applyTheme(), getSystemTheme(), Theme, ThemeContext, ThemeContextValue, ThemeProvider(), ThemeProviderProps, initTelemetry() (+2 more)

### Community 197 - "enum"
Cohesion: 0.17
Nodes (12): type, enum, type, content, outcome, title, properties, type (+4 more)
...
### Community 206 - "prompt-quality-utils.ts"
Cohesion: 0.24
...
## Knowledge Gaps
- **1979 isolated node(s):** `block-local-merge.sh script`, `block-pr-merge.sh script`, `check-branch-before-commit.sh script`, `check-rm-tracked.sh script`, `ci-gate.sh script` (+1974 more)
